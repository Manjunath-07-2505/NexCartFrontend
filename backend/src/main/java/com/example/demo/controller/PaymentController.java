...
public class PaymentController {
     ...
     */
    @PostMapping("/create")
    public ResponseEntity<Object>createPaymentOrder(@RequestBody Map<String, Object> requestBody, HttpServletRequest request) {
        ...
        try {
            ...
            List<OrderItem> cartItems = cartItemsRaw.stream().map(item -> {
                ...
                orderItem.setProductId(Integer.parseInt(item.get("productId").toString()));
            ...
            Object razorpayOrderId = paymentService.createOrder(userId, totalAmount, cartItems);
